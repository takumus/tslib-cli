...
module.exports = {
  packageJSON(body, options) {
    ...
    json.buildSettings.browser.exportWithNodeModules = options.browserExportWithNodeModules;
    json.buildSettings.cjs_esm.exportWithNodeModules = options.cjsesmExportWithNodeModules;
